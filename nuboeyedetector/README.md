[![][NuboMediaImage]][Nubomedia-vca]

Licensed under [LGPL v2.1 License].

nubomedia-filter-eyedetector-js
===============
this module is in charge of detecting eyes. For that purpose, you need to install or use the NUBOMEDIA [NUBOMEDIA] platform.
